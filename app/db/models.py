...
class MarketSnapshot(Base):
    ...
    last_price_dollars: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    yes_bid_dollars: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    yes_ask_dollars: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    no_bid_dollars: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    no_ask_dollars: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    volume_fp: Mapped[float | None] = mapped_column(Numeric(18, 2), nullable=True)
    volume_24h_fp: Mapped[float | None] = mapped_column(Numeric(18, 2), nullable=True)
    open_interest_fp: Mapped[float | None] = mapped_column(Numeric(18, 2), nullable=True)
    liquidity_dollars: Mapped[float | None] = mapped_column(Numeric(18, 4), nullable=True)
...
class Trade(Base):
    ...
    yes_price_dollars: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    no_price_dollars: Mapped[float | None] = mapped_column(Numeric(12, 4), nullable=True)
    count_fp: Mapped[float | None] = mapped_column(Numeric(18, 2), nullable=True)
